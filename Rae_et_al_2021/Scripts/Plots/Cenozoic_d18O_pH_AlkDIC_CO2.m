...
% alk_dic_smooth = smooth(co2_data{8}.age/1000,co2_data{8}.alkalinity./co2_data{8}.dic,100,'loess');
% co2_smooth = smooth(co2_data{8}.age/1000,co2_data{8}.pco2,100,'loess');
...
% plot(co2_data{8}.age/1000,alk_dic_smooth,'--r','Parent',plot_handles(current_plot_index))
...
% plot(co2_data{8}.age/1000,co2_smooth,'--r','Parent',plot_handles(current_plot_index))
...
%% Saving
exportgraphics(gcf,"./Figures/Cenozoic_d18O_pH_AlkDIC_CO2.png","Resolution",600);
exportgraphics(gcf,"./Figures/Cenozoic_d18O_pH_AlkDIC_CO2.pdf");
