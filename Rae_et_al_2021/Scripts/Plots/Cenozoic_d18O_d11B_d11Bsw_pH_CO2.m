...
% Adjust sizes of some datapoints
...
ylabel(plot_handles(current_plot_index),join(["\delta^{11}B_{borate} (",char(8240),")"]))
...
ylabel(plot_handles(current_plot_index),join(["\delta^{11}B_{seawater} (",char(8240),")"]));
